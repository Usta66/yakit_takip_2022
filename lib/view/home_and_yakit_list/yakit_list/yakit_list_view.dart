...
class YakitListView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Consumer<HomeAndYakitListViewModel>(
            builder: (context, value, child) => child!,
            child: const Text("Yakit Listesi")),
      ),
      body: Consumer<HomeAndYakitListViewModel>(
                        ...
                        children: [
                          Expanded(
                            child: CircleAvatarImageAndAlphabet(
                                color: yakitIslemModel.yakitTuru ==
                                        YakitTuruEnum.LPG
                                    ? 0x4D05FF3B
                                    : 0x989F0D7D,
                          ...
                          Expanded(
                            child: Column(
                              children: [
                                ...
                                Padding(
                                  padding:
                                      EdgeInsets.only(top: context.lowValue),
                                  child: Text("Km",
                                      style: Theme.of(context)
                                          .textTheme
                                          .subtitle1),
                                ),
                                Text("${yakitIslemModel.aracKm} KM",
                                    style:
                                        Theme.of(context).textTheme.subtitle2)
                              ],
                            ),
                            ...
                            child: Column(
                              children: [
                                Text("Miktar",
                                    style:
                                        Theme.of(context).textTheme.subtitle1),
                                Text("${yakitIslemModel.miktari} L",
                                    style:
                                        Theme.of(context).textTheme.subtitle2),
                                Padding(
                                  padding:
                            ...
                            child: Column(
                              children: [
                                Text("Fiyat",
                                    style:
                                        Theme.of(context).textTheme.subtitle1),
                                Text("${yakitIslemModel.fiyati} TL",
                                    style:
                                        Theme.of(context).textTheme.subtitle2),
                                Padding(
                                  padding:
                                ...
                                Text(
                                    "${viewModel.mesafeHesapla(index) ?? "---"} KM",
                                    style:
                                        Theme.of(context).textTheme.subtitle2)
                              ],
                            ),
