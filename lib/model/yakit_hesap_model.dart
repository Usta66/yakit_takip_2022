...
class YakitHesapModel {
  ...
  String getToplamLpgMiktari() {
    ...
    if (listYakitIslemModel.isNotEmpty && carModel.yakitTuru == YakitTuruEnum.LPG) {
      Iterable<YakitIslemModel?> result = listYakitIslemModel.where((element) => element!.yakitTuru == YakitTuruEnum.LPG);
      ...
      if (listYakitIslemModelLpg.isNotNullOrEmpty) {
        for (var i = 0; i < listYakitIslemModelLpg.length - 1; i++) {
          if (listYakitIslemModelLpg[i]!.miktari != null) {
            tuketilenLpgMiktari = tuketilenLpgMiktari + listYakitIslemModelLpg[i]!.miktari!;
          }
        }
      }
      ...
      if (listYakitIslemModelLpg.isNotNullOrEmpty) {
        for (var i = 0; i < listYakitIslemModelLpg.length - 1; i++) {
          if (listYakitIslemModelLpg[i]!.tutar != null) {
            tuketilenLpgMaliyeti = tuketilenLpgMaliyeti + listYakitIslemModelLpg[i]!.tutar!;
          }
        }
      }
      ...
      if (listYakitIslemModelAkaryakit.isNotNullOrEmpty) {
        for (var i = 0; i < listYakitIslemModelAkaryakit.length - 1; i++) {
          if (listYakitIslemModelAkaryakit[i]!.miktari != null) {
            tuketilenToplamAkaryakitMiktari = tuketilenToplamAkaryakitMiktari + listYakitIslemModelAkaryakit[i]!.miktari!;
          }
        }
      }
  ...
  String getToplamAkaryakitMaliyeti() {
    ...
    if (listYakitIslemModel.isNotEmpty) {
      ...
      if (listYakitIslemModelAkaryakit.isNotNullOrEmpty) {
        for (var i = 0; i < listYakitIslemModelAkaryakit.length - 1; i++) {
          if (listYakitIslemModelAkaryakit[i]!.miktari != null) {
            tuketilenToplamAkaryakitMaliyeti = tuketilenToplamAkaryakitMaliyeti + listYakitIslemModelAkaryakit[i]!.tutar!;
          }
        }
      }
